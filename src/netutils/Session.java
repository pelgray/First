...
public class Session implements Stoppable {
    ...
    public void run() {
        try {
            ...
            try {
                dOutputStream.writeUTF("SERVER is active");
            } catch (IOException e) {
    ...
    public void stop() {
        if (_socket != null){
            ...
            try {
                ...
                _errorWriter.write("The error of getting the output stream during the process termination.");
                return;
            }
            try {
                dOutputStream.writeUTF("SERVER is stopped");
            } catch (IOException e) {
